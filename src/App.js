...
function App() {
  ...
  const callAPi = async () => {
    const request = await fetch(`${API.base}key=${API.key}&q=${query}&aqi=no}`);
        ...
        <div
          className={
            typeof weather.current === "undefined"
              ...
              : weather.current.condition.text.includes("sunny")
              ? "container container0"
              : weather.current.condition.text.includes("cloud" || "Overcast")
          ...
          {typeof weather.current !== "undefined" ? (
            <>
              ...
              <div className="humwin">
                ...
                <h4>
                  wind speed: <span>{weather.current.wind_kph}</span>kph
                </h4>
              </div>
            </>
          ) : (
